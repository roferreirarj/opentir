...
public class BasicCrudView<T> extends AbsoluteLayout implements
	...
	private static final long serialVersionUID = -6370535299957429409L;
	...
	protected void buildView() {
		...
		commit = new Button("Save", new Button.ClickListener() {
			...
			private static final long serialVersionUID = -8246284580104926686L;
		...
		discard = new Button("Cancel", new Button.ClickListener() {
			...
			private static final long serialVersionUID = 4772092876889248203L;
